...
- If the retained log no longer contains the requested cursor range, the server sends a reset event and the frontend clears metadata cache/list-scroll validity before moving to the current tail.
