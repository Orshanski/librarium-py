...
const defaultAuthorsList = [
  ...
  { id: 2, name: "Isaac Asimov", sortName: "Asimov, Isaac", bookCount: 15, tags: null },
];

const defaultSeriesList = [
  { id: 1, name: "Dune", authors: "Frank Herbert", bookCount: 6 },
  { id: 2, name: "Foundation", authors: "Isaac Asimov", bookCount: 7 },
];
